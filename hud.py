...
class HUD:
    ...
    def __init__(self, game):
        """Initialize the HUD with the font, layout, and text surfaces."""
        self.game = game
    ...
    def update_scores(self):
        """Refresh all score-related HUD text surfaces."""
        self._update_max_score()
        self._update_score()
        self._update_hi_score()

    def _update_score(self):
        """Render the current score and place it in the upper-right area."""
        score_str = f'Score: {self.game_stats.score:,.0f}'
        self.score_image = self.font.render(score_str, True, self.settings.text_color, None)
        self.score_rect = self.score_image.get_rect()
        self.score_rect.topright = (self.boundaries.right - self.padding, self.padding)

    def _update_max_score(self):
        """Render the session max score and place it near the upper center."""
        ...
        self.max_score_rect.top = self.padding + 28

    def _update_hi_score(self):
        """Render the saved high score and place it just below the max score."""
        ...
        self.hi_score_rect.top = self.max_score_rect.bottom + 4
    ...
    def update_level(self):
        """Render the current level and place it below the score labels."""
        ...
        self.level_rect.topleft = (self.padding, self.padding + 70)
    ...
    def draw(self):
        """Draw each HUD element in a non-overlapping layout."""
